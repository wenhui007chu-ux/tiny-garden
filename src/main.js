...
const BUILDING_KEYS = ['workshop', 'mall', 'house', 'pond', 'bank', 'kitchen', 'gourmet', 'tower', 'harbor', 'trainer',
  'hybridLab', 'petHouse', 'greenhouse', 'achievement', 'treasury', 'sorter', 'aquarium', 'blackMarket', 'observatory', 'warehouse', 'brewery', 'foodshop', 'ranch', 'butcher', 'reception'];
